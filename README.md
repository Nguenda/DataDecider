...
3. [Capitalbikeshare.ipynb](https://github.com/Nguenda/DataDecider/blob/main/GA_CapitalBikeshare.ipynb): This file is the complete code file for this project, and users can view and run the code through Jupyter Notebook or web pages.
